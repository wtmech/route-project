      ...
      <form style={{display: 'flex', justifyContent: 'space-evenly'}}>
          ...
          <div className="form-group">
            ...
            <FormControl
              ...
              componentClass={this.state.trainLine === "Amtrak" ? "input" : "select"}
          ...
          <div className="form-group">
            ...
            <FormControl
              ...
              onChange={this.handleChange}
            />
            {this.props.errors.runNumber ? <span className="validation">{this.props.errors.runNumber}</span> : null}
          </div>
          <div className="form-group">
...
export default connect(mapStateToProps, { addRoute })(Form);